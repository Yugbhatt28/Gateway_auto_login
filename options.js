...
async function load() {
  ...
  el("usernameSelector").value = settings.usernameSelector;
  el("passwordSelector").value = settings.passwordSelector;
  el("loginSelector").value = settings.loginSelector;
...
async function save(event) {
  ...
  for (const id of ["usernameSelector", "passwordSelector", "loginSelector"]) {
